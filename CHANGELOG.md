...
* Makes the library compatible with Angular 20

# [8.0.0]

* Restructured the library to follow Angular standards

# [7.1.2]

* Fix parsing has many relationships when there are no models provided
...
* Allow mixed model types in a single HasMany relationship ([#216](https://github.com/ghidoz/angular2-jsonapi/pull/216))

### Bug fixes

* Fix using a relationship config key ([#210](https://github.com/ghidoz/angular2-jsonapi/pull/210))
...
- Update Attribute decorator with a custom property converter ([88d8d30](https://github.com/ghidoz/angular2-jsonapi/commit/88d8d3070928ca57cd7d02c82784363d46eccdb7))
...
- Add existence check on BelongsTo parsing ([3f538a0](https://github.com/ghidoz/angular2-jsonapi/commit/3f538a0))
...
- Add a delete record method ([#28](https://github.com/ghidoz/angular2-jsonapi/issues/28)) ([2f6c380](https://github.com/ghidoz/angular2-jsonapi/commit/2f6c380))
...
- Do not delete relationship from an object when saving a model ([8751d3f](https://github.com/ghidoz/angular2-jsonapi/commit/8751d3f))
...
- Add Attribute decorator and tracking of attributes changes and save only dirty attributes ([fe20b8b](https://github.com/ghidoz/angular2-jsonapi/commit/fe20b8b))
- Add hasDirtyAttributes property to the model ([a38fa1c](https://github.com/ghidoz/angular2-jsonapi/commit/a38fa1c))
- Add a rollbackAttributes () method to the model ([fc377fb](https://github.com/ghidoz/angular2-jsonapi/commit/fc377fb))
- Upgrade to Angular 2.0.0 final version ([3c30cdd](https://github.com/ghidoz/angular2-jsonapi/commit/3c30cdd))

### BREAKING CHANGES

- It's mandatory to decorate each model’s property with the `Attribute()` decorator
- The `createRecord()` method does not call the API anymore, it just creates the object. To save the object on the server, you need to call the `save()` method on the model.
